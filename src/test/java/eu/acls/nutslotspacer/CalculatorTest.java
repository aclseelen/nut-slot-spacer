...
class CalculatorTest {
  ...
  void calculate6StringsEdgeOfOuterStrings() {
    ...
    Calculator calculator = new Calculator(3.175, 3.175, 43.0, false);
  ...
  @Test
  void calculate6StringsEdgeOfOuterStringsInches() {

    Calculator calculator = new Calculator(0.125, 0.125, 1.6929133858267716535433070866141732283464566929133858267716535433, false);
    calculator.getStringDiameters().clear();
    calculator.addStringDiameter(10, 13, 17, 26, 36, 46);
    calculator.setUseInchesAsInput(true);
    calculator.getStringDiameters().sort(Comparator.reverseOrder());
  ...
  void calculate6StringsCenterOfOuterStrings() {
    ...
    Calculator calculator = new Calculator(3.175, 3.175, 43.0, true);
    calculator.getStringDiameters().clear();
    calculator.addStringDiameter(10, 13, 17, 26, 36, 46);
    calculator.getStringDiameters().sort(Comparator.reverseOrder());
